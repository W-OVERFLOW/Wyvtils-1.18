...
import net.wyvest.wyvtils.listener.events.UpdateEvent
...
object Updater {
    ...
    fun update() {
        updateFuture = Multithreading.submit {
            val latestRelease =
                APIUtil.getJSONResponse("https://api.github.com/repos/Wyvest/Wyvtils-1.18/releases/latest")
            ...
            if (currentVersion < latestVersion) {
                ...
                shouldUpdate = true
                Wyvtils.eventBus.post(UpdateEvent(latestTag))
            }
        }
    }
